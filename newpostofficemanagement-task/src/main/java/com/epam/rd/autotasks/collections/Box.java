...
public class Box implements Cloneable {
    ...
    public boolean equals(Object o) {
        ...
        Box box = (Box) o;
        return id == box.id && Double.compare(box.weight, weight) == 0 && Double.compare(box.volume, volume) == 0 && office == box.office && sender.equals(box.sender) && recipient.equals(box.recipient) && cost.equals(box.cost) && city.equals(box.city);
    }
